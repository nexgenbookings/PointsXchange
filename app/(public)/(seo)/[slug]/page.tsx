    ...
    <div className="bg-[#080C18]">
      <div className="relative overflow-hidden border-b border-white/8">
        ...
        <div className="mx-auto max-w-5xl px-4 py-14 lg:px-8">
          ...
          <p className="mt-6 text-lg leading-8 text-white/60">{page.intro}</p>
        </div>
      </div>
      <section className="mx-auto max-w-5xl px-4 py-14 lg:px-8">
        ...
        <div className="mt-10 space-y-5 leading-8 text-white/60">
        ...
        <div className="mt-12 rounded-2xl border border-white/8 bg-[#111827] p-6">
          ...
          {["Can I get paid quickly?", "Do you offer exact pricing online?", "Can you beat another offer?"].map((question) => (
            <div key={question} className="mt-6 border-t border-white/8 pt-5">
              ...
              <p className="mt-2 leading-7 text-white/60">Submit an instant quote or contact the desk. We review every transaction individually for security, payout availability, and competitive market value.</p>
            </div>
          ))}
        </div>
      </section>
